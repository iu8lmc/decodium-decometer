...
set "OUT=%USCITA%\Decometer-1.0.0.aab"
set "LAVORO=%USCITA%\Decometer-1.0.0.firma-in-corso.aab"
...
echo versione 1.0.0 (codice 1): dalla prossima pubblicazione il codice va
